...
const Button = styled.button`
  ...
  :hover {
    background-color: ${props =>
      props.backgroundColor === 'grey' ? props => props.theme.colors.buttonGrey : props.theme.colors.darker_blue};
  }
  :active {
