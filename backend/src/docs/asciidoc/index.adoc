...
.http-request
include::{snippets}/yataRequest-getAll/http-request.adoc[]
.path-parameters
include::{snippets}/yataRequest-getAll/path-parameters.adoc[]
.http-response
include::{snippets}/yataRequest-getAll/http-response.adoc[]
.response-fields
include::{snippets}/yataRequest-getAll/response-fields.adoc[]
.response-body
include::{snippets}/yataRequest-getAll/response-body.adoc[]
