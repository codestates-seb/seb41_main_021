...
.request-parameters
include::{snippets}/member-get-others/request-parameters.adoc[]
.request-parameters
include::{snippets}/member-get-others/request-parameters.adoc[]
...
.http-request
include::{snippets}/yata-getMy/http-request.adoc[]
.request-headers
include::{snippets}/yata-getMy/request-headers.adoc[]
.response-body
include::{snippets}/yata-getMy/response-body.adoc[]
.http-response
include::{snippets}/yata-getMy/http-response.adoc[]

=== 내가 신청한 야타 게시글 중 신청 수락된 게시글
GET api/ve/yata/accept/yatas
