...
public enum ExceptionCode {
    ...
    CANNOT_APPROVE(403,"CANNOT_APPROVE"),
    UNAUTHORIZED(403, "UNAUTHORIZED"),
    INVALID_ELEMENT(400, "INVALID_ELEMENT"),
    INVALID_TIME(400, "INVALID_TIME"),
    ...
    YATA_MEMBER_NONE(400,"YATA_MEMBER_NONE"),

    PAYMENT_NOT_YET(403,"PAYMENT_NOT_YET"),
    AlREADY_PAID(409,"ALREADY_PAID"),

    ALREADY_REVIEWED(409,"ALREADY_REVIEWED"),
    CANNOT_CREATE_REVIEW(403,"CANNOT_CREATE_REVIEW"),
    INVALID_TIME_OF_ARRIVAL(400,"INVALID_TIME_OF_ARRIVAL"),
    INVALID_PAYMENT_AMOUNT(400,"MUST_BE_1000OVER" ),
    ALREADY_REGISTERED(400,"ALREADY_REGISTERED" ),
    ALREADY_PAY(400,"ALREADY_PAY");
